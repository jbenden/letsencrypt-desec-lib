...
desec_acme_challenge_create "$CERTBOT_DOMAIN" "$CERTBOT_VALIDATION" || \
    desec_acme_challenge_update "$CERTBOT_DOMAIN" "$CERTBOT_VALIDATION" || exit 5

desec_acme_challenge_poll "$CERTBOT_DOMAIN" "$CERTBOT_VALIDATION" || exit 5
